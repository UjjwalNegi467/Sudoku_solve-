...
if (arr[gridy + i / 3][gridx + i % 3] == n) { status = false;
break; }
}
return status;
}
void nextEmpty(int arr[9][9], int row, int col, int& rowNext, int&
colNext)
{
int indexNext = 9 * 9 + 1;
...
cout<<"\n\t\t\t\tADA MTE PROJECT \n"<<endl ;
/* METHOD 1 */
// In this method the input of the board is defined in the code itself
// int board[9][9] = {
// {5,3,0,0,7,0,0,0,0},
// {6,0,0,1,9,5,0,0,0},
// {0,9,8,0,0,0,0,6,0},
...
// };
/* METHOD 2 */
// In this method the input of the board is entered by user at the
time of running of the code
// int board[9][9] ;
// for (int i = 0; i < 9; i++)
// {
// cout<<"Enter the elements of row "<<i+1<<"(if no element is
present enter 0)"<<endl ;
// for (int j = 0; j < 9; j++)
// {
// cin>>board[i][j];
// }
// }
/* METHOD 3 */
// In this method the input of the board is taken from a txt file
